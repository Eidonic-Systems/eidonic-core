param(
    [string]$CurrentPath = ".\evals\governance_eval_results.json",
    [string]$BaselinePath = ".\evals\baselines\governance_eval_baseline.json"
)
...
Write-Host ""
Write-Host "Comparing governance eval results to baseline..." -ForegroundColor Yellow
...
if ($summary.status -ne "passed") {
    throw "Governance eval baseline comparison failed."
}

Write-Host ""
Write-Host "Governance eval baseline comparison passed." -ForegroundColor Green
