param(
    [string]$CurrentPath = ".\evals\domain_task_eval_results.json",
...
Write-Host ""
Write-Host "Comparing domain task eval results to baseline..." -ForegroundColor Yellow
...
if ($summary.status -ne "passed") {
    throw "Domain task eval baseline comparison failed."
}

Write-Host ""
Write-Host "Domain task eval baseline comparison passed." -ForegroundColor Green
